    ...
    const getReportableText = () => {
        switch (report.reportable_type) {
            ...
            case 'post':
                ...
                return report.reportable_exists ? t('deleted_post_no') : t('deleted_post_no', { id: post_snapshot.id });
            case 'comment':
    ...
    return (
        <Card>
            ...
            <CardFooter className="flex gap-2">
                ...
                {!report.closed_at && (
                    <Button variant="destructive" onClick={() => alert('Cerrar reporte aún no implementado')}>
                        {t('close_report')}
                    </Button>
                )}
