...
class FollowController extends Controller
{
    ...
    public function toggle(Request $request, User $user)
    {
        ...
        $wasFollowing = in_array($user->id, $result['detached']);
    ...
    public function followers(Request $request, User $user)
    {
        ...
        $followingIds = $auth_user->followedUserIds();
        ...
        $followers->setCollection(
            $auth_user
                ...
                : $followers->getCollection()->map(fn($u) => $u->setAttribute('isFollowing', null))
        );
    ...
    public function following(Request $request, User $user)
    {
        ...
        $following->setCollection(
            $auth_user
                ...
                : $following->getCollection()->map(fn($u) => $u->setAttribute('isFollowing', null))
        );
