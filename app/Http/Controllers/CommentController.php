...
{
    // Inyecta el servicio MentionService para gestionar las menciones asociadas a comentarios.
    ...
    public function store(Request $request, Post $post)
    {
        ...
        // Si el autor de la publicación ha bloqueado al usuario autenticado, no puede comentar.
        ...
        // Si el autor del comentario no es el mismo que el autor de la publicación
        // y este último no ha sido mencionado, se le notifica.
        ...
        // Se agrega el autor de la publicación a la lista de usuarios notificados.
        ...
        // Se excluyen los usuarios que hayan bloqueado al autor del comentario o que hayan
        // sido bloqueados por él.
        ...
        // Se notifica a los demás comentaristas que se ha publicado un nuevo comentario.
    ...
    {
        // Deniega acceso si el usuario no está autorizado para actualizar el comentario.
    ...
    {
        // Deniega acceso si el usuario no está autorizado para eliminar el comentario.
